// // Array para armazenar os usuários autenticados
...
//     if (userRole === "admin-seguranca" && username === "admin" && password === "admin123") {
//         isAuthenticated = true;
//         welcomeMessage = 'Bem-vindo, Administrador de Segurança!';
//     } else if (userRole === "gerente" && username === "gerente" && password === "gerente123") {
//         isAuthenticated = true;
//         welcomeMessage = 'Bem-vindo, Gerente!';
//     } else if (userRole === "funcionario" && username === "funcionario" && password === "func123") {
//         isAuthenticated = true;
...
//     if (isAuthenticated) {
//         // Armazena o usuário autenticado no array
